...
public enum Messages {
    ...
    BATTLEPASS_REWARDS_PENDING("messages.battlepass-rewards-pending", "&7Quest &c{quest} &7complete! Open the battle pass to claim your rewards."),
    BATTLEPASS_CLAIM_FREE("messages.battlepass-claim-free", "&7You claimed the free reward for &c{quest}&7."),
    BATTLEPASS_CLAIM_PREMIUM("messages.battlepass-claim-premium", "&7You claimed the premium reward for &c{quest}&7."),
    BATTLEPASS_CLAIM_BOTH("messages.battlepass-claim-both", "&7You claimed the free and premium reward for &c{quest}&7."),
    BATTLEPASS_CLAIM_NEED_PREMIUM("messages.battlepass-claim-need-premium", "&7Buy the premium battle pass to claim this reward."),
    BATTLEPASS_TIER_LOCKED("messages.battlepass-tier-locked", "&7Complete all quests in the previous tier to unlock tier &c{tier}&7."),
    COMMAND_BATTLEPASS_DISABLED("messages.command-battlepass-disabled", "&7The battle pass is not enabled on this server."),
    COMMAND_BATTLEPASS_NO_QUESTS("messages.command-battlepass-no-quests", "&7No battle pass quests are configured yet."),
